...
# Find Python3 and set PYTHON_EXECUTABLE for compatibility with older CMake code
...
function(_rtt_ros2_generate_typekit _package)
  ...
  # Mark generated files so CMake knows to wait for them
  set_source_files_properties(${_generated_header_files} ${_generated_source_files}
    PROPERTIES GENERATED TRUE)

  # Create a target for the generated files to enforce proper build ordering
  add_custom_target(${_target}_generate
    DEPENDS ${_generated_header_files} ${_generated_source_files}
  )
